...
import { ComponentLyricsDisplayWindow } from "./app/ComponentLyricsDisplayWindow";
...
function App() {
  ...
  if (currentWindowKind === "component-lyrics-display") {
    return <ComponentLyricsDisplayWindow />;
  }
