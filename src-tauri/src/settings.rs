...
pub struct AppearanceSettings {
    ...
    pub immersive_background_dim: u8,
...
impl Default for AppearanceSettings {
    fn default() -> Self {
        Self {
            ...
            immersive_background_blur: 36,
            immersive_background_dim: 18,
...
fn sanitize_settings(mut settings: AppSettings) -> AppSettings {
    ...
    settings.appearance.immersive_background_blur =
        settings.appearance.immersive_background_blur.clamp(0, 100);
    settings.appearance.immersive_background_dim =
        settings.appearance.immersive_background_dim.clamp(0, 100);
